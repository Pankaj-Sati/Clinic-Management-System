...
function printDiv() 
	{
	  ...
	  newWin.document.write('<html><head>'+
							...
							'<p align="right" style="font-size: 20px; color:#111">Date :'+today.toShortFormat()+'</p>'+
							'<div style="width:900;">'+divToPrint.innerHTML+'</div>'+
							'<img style="height:auto;width:1000" src="images/print_tests.JPG"/>'+
							'<hr></center><div style="position:absolute; bottom:0;">'+
